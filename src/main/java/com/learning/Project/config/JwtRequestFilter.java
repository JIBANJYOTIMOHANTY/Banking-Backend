...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    JwtRequestFilter(CustomUserDetailsService userDetailsService, JwtTokenUtil jwtTokenUtil,
            ...
            try {
                ...
                if (Boolean.TRUE.equals(hasSession)) {
                    ...
                    if (jwtTokenUtil.getBootId().equals(tokenBootId)) {
                        ...
                        // Sliding expiration: user is active, so refresh TTL in Redis if it's the
                        // active token
                        if (username != null) {
                        ...
                        logger.warn(
                                "JWT Boot ID mismatch. Token was generated by a previous application run. Invalidating.");
